export function DeleteConfirmModal({ databaseName, onConfirm, onCancel, loading }) {
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true" aria-labelledby="delete-modal-title">
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6" onClick={(e) => e.stopPropagation()}>
          <h2 id="delete-modal-title" className="text-lg font-semibold text-gray-900 mb-2">Delete Database</h2>
          <p className="text-gray-600 mb-6">
            Are you sure you want to delete <strong>{databaseName}</strong>? This action cannot be undone and will permanently delete all associated collections and data.
          </p>
