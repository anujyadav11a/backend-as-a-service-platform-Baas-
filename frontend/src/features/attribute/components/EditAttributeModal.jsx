...
export function EditAttributeModal({ attribute, isOpen, onClose, onSubmit, loading }) {
  ...
  const onFormSubmit = async (data) => {
    ...
    if (!result.success) {
      setSubmitError(result.error || 'Failed to update attribute');
    }
  };
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-between mb-6">
            <h2 id="edit-modal-title" className="text-lg font-semibold text-gray-900">Edit Attribute</h2>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  aria-required="true"
                  aria-describedby={errors.type ? 'edit-type-error' : 'edit-type-help'}
              ...
              {errors.type && (
                <p id="edit-type-error" className="mt-1 text-sm text-red-600" role="alert">
                  {errors.type.message}
                </p>
              )}
              <p id="edit-type-help" className="mt-1 text-xs text-gray-500">Examples: VARCHAR(255), INT, TEXT, BOOLEAN, DECIMAL(10,2), ENUM('a','b')</p>
            </div>
            ...
            <div>
              <div className="flex items-center">
                <input
                  ...
                  disabled={loading}
                />
                <label htmlFor="edit-required" className="ml-3 block text-sm font-medium text-gray-700">
                  Required
                </label>
              </div>
