...
export function DeleteConfirmModal({ attributeName, onConfirm, onCancel, loading }) {
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-between mb-4">
            <h2 id="delete-modal-title" className="text-lg font-semibold text-gray-900">Delete Attribute</h2>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-600">
                Are you sure you want to delete the attribute <strong>{attributeName}</strong>?
              </p>
              <p className="mt-2 text-sm text-gray-500">
                This action cannot be undone. All data stored in this attribute will be permanently lost.
              </p>
            </div>
          </div>
