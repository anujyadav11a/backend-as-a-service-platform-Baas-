...
export function EditProjectModal({ isOpen, onClose, onSubmit, initialData, loading }) {
  ...
  const onFormSubmit = async (data) => {
    ...
    if (result.success) {
      ...
      setSubmitError(result.error || 'Failed to update project');
    }
  };
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-between mb-4">
            <h2 id="edit-modal-title" className="text-lg font-semibold text-gray-900">Edit Project</h2>
